...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'registryGroup'
        db.create_table(u'aristotle_mdr_registrygroup', (
        ...
        db.send_create_signal(u'aristotle_mdr', ['registryGroup'])

        # Adding model 'RegistrationAuthority'
        db.create_table(u'aristotle_mdr_registrationauthority', (
            (u'registrygroup_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['aristotle_mdr.registryGroup'], unique=True, primary_key=True)),
        ...
        db.create_table(u'aristotle_mdr_discussionpost', (
            ...
            ('workgroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aristotle_mdr.Workgroup'])),
        ...
        # Adding M2M table for field registrationAuthorities on 'PossumProfile'
        m2m_table_name = db.shorten_name(u'aristotle_mdr_possumprofile_registrationAuthorities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('possumprofile', models.ForeignKey(orm[u'aristotle_mdr.possumprofile'], null=False)),
            ('registrationauthority', models.ForeignKey(orm[u'aristotle_mdr.registrationauthority'], null=False))
        ))
        db.create_unique(m2m_table_name, ['possumprofile_id', 'registrationauthority_id'])

        # Adding M2M table for field workgroups on 'PossumProfile'
        m2m_table_name = db.shorten_name(u'aristotle_mdr_possumprofile_workgroups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('possumprofile', models.ForeignKey(orm[u'aristotle_mdr.possumprofile'], null=False)),
            ('workgroup', models.ForeignKey(orm[u'aristotle_mdr.workgroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['possumprofile_id', 'workgroup_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'registryGroup'
        db.delete_table(u'aristotle_mdr_registrygroup')
        ...
        # Removing M2M table for field registrationAuthorities on 'PossumProfile'
        db.delete_table(db.shorten_name(u'aristotle_mdr_possumprofile_registrationAuthorities'))

        # Removing M2M table for field workgroups on 'PossumProfile'
        db.delete_table(db.shorten_name(u'aristotle_mdr_possumprofile_workgroups'))
    ...
    models = {
        ...
        u'aristotle_mdr.discussionpost': {
            ...
            'workgroup': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['aristotle_mdr.Workgroup']"})
        },
        ...
        u'aristotle_mdr.possumprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'registrationAuthorities': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['aristotle_mdr.RegistrationAuthority']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'workgroups': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'members'", 'blank': 'True', 'to': u"orm['aristotle_mdr.Workgroup']"})
        },
        ...
        u'aristotle_mdr.registrationauthority': {
            'Meta': {'object_name': 'RegistrationAuthority', '_ormbases': [u'aristotle_mdr.registryGroup']},
            ...
            u'registrygroup_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['aristotle_mdr.registryGroup']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'aristotle_mdr.registrygroup': {
            'Meta': {'object_name': 'registryGroup'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('tinymce.models.HTMLField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
        ...
        u'aristotle_mdr.workgroup': {
            'Meta': {'object_name': 'Workgroup', '_ormbases': [u'aristotle_mdr.registryGroup']},
